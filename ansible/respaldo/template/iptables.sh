...
iptables -A FORWARD -p tcp --dport 53 -o eth0 -j ACCEPT
iptables -A FORWARD -p tcp --sport 53 -i eth0 -j ACCEPT

iptables -A FORWARD -p udp --dport 53 -o eth0 -j ACCEPT
...
#################SSH puedo conectarme desde el servidor a todos sitios, pero no conectame a él
...
#iptables -A FORWARD -s 192.168.11.0/24 -i eth1 -p tcp --sport 20:21
#iptables -A FORWARD -s 192.168.11.0/24 -o eth1 -p tcp --dport 20:21
